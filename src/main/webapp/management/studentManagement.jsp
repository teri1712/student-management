                        ...
                        <div class="col-md-6 text-md-end mt-3 mt-md-0">
                            <div class="dropdown">
                                <button class="btn btn-primary dropdown-toggle" type="button" id="sortDropdown"
                                    ...
                                    Sort By <%= currentSortBy != null ? currentSortBy : "" %>
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                                    <li><a class="dropdown-item"
                                           href="${pageContext.request.contextPath}/management/student/list?sortBy=fullname<%= currentQuery != null ? "&query=" + currentQuery : "" %>">Sort
                                        by Name</a></li>
                                    <li><a class="dropdown-item"
                                           href="${pageContext.request.contextPath}/management/student/list?sortBy=grade<%= currentQuery != null ? "&query=" + currentQuery : "" %>">Sort
                                        by Grade</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <li class="page-item <%= currentPage <= 0 ? "disabled" : "" %>">
                                    <a class="page-link"
                                       href="${pageContext.request.contextPath}/management/student/list?<%= currentQuery != null ? "&query=" + currentQuery : "" %><%= currentSortBy != null ? "&sortBy=" + currentSortBy : "" %>&page=<%= currentPage - 1 %>"
                                       aria-label="Previous">
                                ...
                                <li class="page-item <%= currentPage == i ? "active" : "" %>">
                                    <a class="page-link"
                                       href="${pageContext.request.contextPath}/management/student/list?<%= currentQuery != null ? "&query=" + currentQuery : "" %><%= currentSortBy != null ? "&sortBy=" + currentSortBy : "" %>&page=<%= i %>"><%= i + 1 %>
                                    </a>
                                </li>
                                <% } %>
