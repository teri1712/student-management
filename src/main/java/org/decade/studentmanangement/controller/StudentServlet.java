...
public class StudentServlet extends HttpServlet {
        ...
        private void handleListRequest(HttpServletRequest request, HttpServletResponse response) throws Exception, ServletException, IOException {
                ...
                request.getRequestDispatcher("/WEB-INF/management/studentManagement.jsp").forward(request, response);
        }
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
                ...
                try {
                        if ("/list".equals(path)) {
                                ...
                                req.getRequestDispatcher("/WEB-INF/management/addstudent.jsp").forward(req, resp);
                        } else {
                ...
                try {
                        ...
                        if (s == null) {
                                ...
                                try {
                                        ...
                                        if (existing == null) {
                                                // default username/password = student ID
                                                StaffUser su = new StaffUser(fullname, id, id, "student");
                                                userDao.addUser(su);
                                        }
